...
<div class="card">
    <h2 class="section-title">
        ...
        Masuk dengan NIS / Email pembayaran SIPDEI Dar el-Iman 
    </h2>
    
    <div class="alert alert-info">
        Gunakan NIS dan password akun pembayaran SIPDEI Dar el-Iman Anak untuk memverifikasi identitas dan memulai pendaftaran.
    </div>
    ...
    <form action="{{ route('login.process') }}" method="POST" id="loginForm">
        ...
        <div class="form-group">
            ...
            <input type="text" name="email" id="email" class="form-input" value="{{ old('email') }}" required autofocus autocomplete="email">
            @error('email')
